...
$um_userform_uid = "Uid<br>(pureftpd or www-data for WordPress)";
$um_userform_gid = "Gid<br>(pureftpd or www-data for WordPress)";
...
$um_t_th4 = "Gid";
$um_t_th5 = "Folder";
$um_t_th6 = "upload limit (kb/s)";
$um_t_th7 = "download limit (kb/s)";
$um_t_th8 = "Permitted IP";
$um_t_th9 = "QuotaSize";
$um_t_th10 = "QuotaFiles";
...
$du_error = "ERROR: ".var_export($result, true);
...
$wu_add_resulterror = "ERROR: ".var_export($result, true);
...
$ewu_edit_loginerror = "ERROR: ".var_export($result, true);
$ewu_edit_passwdok = "Password for user {$array['User']} successfully changed";
$ewu_edit_passwderror = "ERROR: ".var_export($result, true);
$ewu_edit_languageok = "Language for user {$array['User']} successfully changed";
$ewu_edit_languageerror = "ERROR: ".var_export($result, true);
...
$ewu_del_resulterror = "ERROR: ".var_export($result, true);
$ewu_del_notchecked = "User not checked";
// Settings
$settings_title = "Settings";
$settings_ftp_uid_ok = "Default FTP Uid successfully changed";
$settings_ftp_uid_error = "ERROR: ".var_export($result, true);
$settings_ftp_gid_ok = "Default FTP Gid successfully changed";
$settings_ftp_gid_error = "ERROR: ".var_export($result, true);
$settings_ftp_dir_ok = "Default FTP directory successfully changed";
$settings_ftp_dir_error = "ERROR: ".var_export($result, true);
$settings_upload_speed_ok = "Default upload speed limit successfully changed";
$settings_upload_speed_error = "ERROR: ".var_export($result, true);
$settings_download_speed_ok = "Default download speed limit successfully changed";
$settings_download_speed_error = "ERROR: ".var_export($result, true);
$settings_quota_size_ok = "Default quota size for downloaded/uploaded data successfully changed";
$settings_quota_size_error = "ERROR: ".var_export($result, true);
$settings_quota_files_ok = "Default quota size for downloaded/uploaded files count successfully changed";
$settings_quota_files_error = "ERROR: ".var_export($result, true);
$settings_permitted_ip_ok = "Default permitted IP successfully changed";
$settings_permitted_ip_error = "ERROR: ".var_export($result, true);
$settings_pureftpd_conf_path_ok = "Pure-FTPd config file path successfully changed";
$settings_pureftpd_conf_path_error = "ERROR: ".var_export($result, true);
$settings_pureftpd_init_script_path_ok = "Pure-FTPd init script path successfully changed";
$settings_pureftpd_init_script_path_error = "ERROR: ".var_export($result, true);
$settings_pureftpwho_path_ok = "Pure-FTPWHO script path successfully changed";
$settings_pureftpwho_path_error = "ERROR: ".var_export($result, true);
$settings_title2 = "Pure-FTPd WebUI settings";
$settings_ftp_uid = "Default Uid";
$settings_ftp_gid = "Default Gid";
